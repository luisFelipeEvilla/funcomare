...
export default function OrderBy(props: {
  ...
  return (
    <Select
      ...
      classNames={{
        trigger: "bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 border border-blue-300 dark:border-blue-700 rounded-md",
        label: "text-blue-600 dark:text-blue-400",
        listbox: "bg-white dark:bg-gray-800 border border-blue-300 dark:border-blue-700 rounded-md",
      }}
    >
      <SelectItem 
        key="created_at-desc" 
