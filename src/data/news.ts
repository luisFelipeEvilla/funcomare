const news = [
    {
        id: 1,
        title: 'Ceremonia de reconocimiento a El Buen Samario',
        ...
        resultados de las Pruebas de Estado Saber 11 y Saber Pro. 
        `,
    ...
    {
        id: 2,
        title: 'Talleres de formación en el centro educativo distrital la hermosa',
        description: `
